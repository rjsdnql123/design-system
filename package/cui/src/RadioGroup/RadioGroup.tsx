...
const RadioGroup = (props: React.PropsWithChildren<RadioGroupProps>) => {
  const { value, name, initialValue, disabled, onChange, className, useRow, children } = props;

  const [radioSelfValue, setRadioSelfValue] = useState<string | number | undefined>(initialValue);
