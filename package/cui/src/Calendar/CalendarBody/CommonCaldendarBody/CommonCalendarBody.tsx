...
import {
  calendarCellWrapperStyle,
  calendarWeekStyle,
  commonCalendarDaySpan,
  commonCalendarDayStyle,
} from './CommonCalendar.css';
...
const CommonCalendarBody = ({ currentMonth, className }: CommonCalendarProps) => {
  const { currentMonth: groupMonth, onChange: CalendarOnChange } = useCalendarGroupContext();
